...
{
    public Text runText,rememberText,sizeText, musicText, SEText,langText;
    ...
    override protected void init()
    {
        ...
        if (gameManager.instance.setting.windowSize == 5)
            sizeText.text = "全屏";
        else
        ...
        if (gameManager.instance.setting.alwaysRun)
            ...
            runText.text = "OFF";
        if (gameManager.instance.setting.commandRemember)
            rememberText.text = "ON";
        else
            rememberText.text = "OFF";
    ...
    void changeBool()
    {
        ...
        {
            gameManager.instance.changeBool("commandremember");
            if (gameManager.instance.setting.commandRemember)
                rememberText.text = "ON";
            else
                rememberText.text = "OFF";
