...
namespace Actions
{
    public class eventTools : dataComponent
    {
        ...
        {
            MI.showEventChoosePanel(maintext, choices, texts, nowState.move, null, black);
        }
        ...
        public void playVideo(string name,Func call)
        {
            MI.showVideoPanel(name, call);
        }
        ...
        {
            return MI.showCanDoHint(pos,scale);
        }
        ...
        {
            return MI.showButton(index, _pos, btn,call);
        }
