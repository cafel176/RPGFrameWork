...
namespace BaseData
{
    ...
    public class myEvent : myTreeNode
    {
        ...
        public static string eventTypeToName(eventType _type)
        {
            ...
            switch (_type)
            {
                case eventType.none: t = "空操作"; break;
                ...
                case eventType.actorPlayAnima: t = "角色播放动画"; break;
                ...
                case eventType.changeTurn2D: t = "设置人物朝向2D"; break;
                case eventType.changeTurn3D: t = "设置人物朝向3D"; break;
                ...
                case eventType.choicePanel: t = "选项菜单"; break;
                case eventType.playVideo: t = "播放视频"; break;
                case eventType.enableAttack: t = "允许攻击"; break;
                case eventType.disableAttack: t = "禁止攻击"; break;
                case eventType.showButton: t = "显示按钮"; break;
                case eventType.hideButton: t = "隐藏按钮"; break;
    ...
    {
        protected override void showEditWin()
        {
            if (GUILayout.Button("查看树结构"))
            {
                var window = EditorWindow.GetWindow(typeof(EventTreeStructWin), true, "树结构") as EventTreeStructWin;
                window.Init(tree);
                window.Show();
            }
        }
        ...
        protected override void drawInspector(myEvent e)
        {
            ...
            {
                e.str1 = EditorGUILayout.TextField("视频名称", e.str1);
            }
            ...
            else if (e.type == eventType.movePic)
            {
                ...
                e.vec1 = EditorGUILayout.Vector3Field("移动目标位置", e.vec1);
                EditorGUILayout.BeginHorizontal();
                e.helper = (Transform)EditorGUILayout.ObjectField(e.helper, typeof(Transform));
                if (GUILayout.Button("仅数值"))
                {
            ...
            else if (e.type == eventType.changeScene)
            {
                ...
                e.vec1 = EditorGUILayout.Vector3Field("位置", e.vec1);
                e.vec2 = EditorGUILayout.Vector3Field("新的朝向3D", e.vec2);
                EditorGUILayout.BeginHorizontal();
                e.helper = (Transform)EditorGUILayout.ObjectField(e.helper, typeof(Transform));
                if (GUILayout.Button("仅数值"))
                {
                    e.vec1 = e.helper.position;
                    e.vec2 = e.helper.rotation.eulerAngles;
                    e.helper = null;
                }
                EditorGUILayout.EndHorizontal();
                e.turn = (turn)EditorGUILayout.EnumPopup("新的朝向2D", e.turn);
            }
            ...
            {
                e.str1 = EditorGUILayout.TextField("预制体名", e.str1);
                e.str2 = EditorGUILayout.TextField("动画名", e.str2);
                e.vec1 = EditorGUILayout.Vector3Field("位置", e.vec1);
                EditorGUILayout.BeginHorizontal();
                e.helper = (Transform)EditorGUILayout.ObjectField(e.helper, typeof(Transform));
                if (GUILayout.Button("仅数值"))
            ...
            else if (e.type == eventType.changeTurn3D)
            {
                e.findType = (findType)EditorGUILayout.EnumPopup("查找类型", e.findType);
                e.str1 = EditorGUILayout.TextField("文本", e.str1);
                e.vec1 = EditorGUILayout.Vector3Field("新的朝向", e.vec1);
            }
            ...
            else if (e.type == eventType.changeThingPos)
            {
                e.findType = (findType)EditorGUILayout.EnumPopup("查找类型", e.findType);
                e.str1 = EditorGUILayout.TextField("文本", e.str1);
                e.vec1 = EditorGUILayout.Vector3Field("设置位置", e.vec1);
                EditorGUILayout.BeginHorizontal();
                e.helper = (Transform)EditorGUILayout.ObjectField(e.helper, typeof(Transform));
                if (GUILayout.Button("仅数值"))
                {
            ...
            {
                e.str1 = EditorGUILayout.TextField("按钮编号", e.str1);
                e.str2 = EditorGUILayout.TextField("按钮名", e.str2);
                e.vec1 = EditorGUILayout.Vector3Field("位置坐标", e.vec1);
                EditorGUILayout.BeginHorizontal();
                e.helper = (Transform)EditorGUILayout.ObjectField(e.helper, typeof(Transform));
                if (GUILayout.Button("仅数值"))
                ...
                EditorGUILayout.EndHorizontal();
                EditorGUILayout.LabelField("点击: ");
                e.str3 = EditorGUILayout.TextField("点击，子节点id", e.str3);
            ...
            {
                e.str1 = EditorGUILayout.TextField("菜单文本", e.str1);
                EditorGUILayout.HelpBox("以下文本中请注意不要包含符号\'#\'",MessageType.Warning);
                ...
                e.str2 = EditorGUILayout.TextField("选项1文本", txts[0]) + "#" + EditorGUILayout.TextField("选项1子节点id", txts[1]);
                ...
                e.str3 = EditorGUILayout.TextField("选项2文本", txts2[0]) + "#" + EditorGUILayout.TextField("选项2子节点id", txts2[1]);
                ...
                e.str4 = EditorGUILayout.TextField("选项3文本", txts3[0]) + "#" + EditorGUILayout.TextField("选项3子节点id", txts3[1]);
            }
        }
    }
#endif
