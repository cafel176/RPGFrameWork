...
public class HashsAndTags : MonoBehaviour
{
    ...
    public string start = "Start", end = "End", endImmediately= "EndImmediately";

    // Animator hashs
    [Header("Animator的hashs")]
    ...
    {
        tags = new string[] { specialText,playerBullet };
        ...
        Physics2D.IgnoreLayerCollision(LayerMask.NameToLayer(player), LayerMask.NameToLayer(playerBullet), true);
        Physics2D.IgnoreLayerCollision(LayerMask.NameToLayer(playerBullet), LayerMask.NameToLayer(playerBullet), true);

        Physics.IgnoreLayerCollision(LayerMask.NameToLayer(player), LayerMask.NameToLayer(playerBullet), true);
    ...
    {
        string[] scenePath = { @"/Engine/Scenes/", @"/Game/Scenes/" };
